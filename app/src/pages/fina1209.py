...
# Page Content
# -----------------------------------
st.title("FINA 1209 – Personal Finance")
...
with col3: st.metric("Total Reviews", "1", help="Number of student reviews (FINA 1209 only)")
st.divider()
...
with col2: st.write("**Common Themes:**\n- High difficulty\n- Lower enjoyment\n- Introductory personal finance concepts")
st.divider()
...
notes_list = [
    {"title": "Personal Finance Midterm Study Guide", "file": "fina1209_midterm.pdf"},
    {"title": "Budgeting & Saving Notes", "file": "fina1209_budgeting.docx"},
    {"title": "Final Exam Review Sheet", "file": "fina1209_final.pdf"},
]
...
- 🎥 [YouTube Playlist: Personal Finance Essentials](#)  
- 📊 [Practice Problems – Budgeting & Saving](#)  
""")
