...
# Page Content
# -----------------------------------
st.title("COMM 1112 – Public Speaking")
...
with col3: st.metric("Total Reviews", "1", help="Number of student reviews (COMM 1112 only)")
st.divider()
...
with st.expander("⭐ Professor: Nazanin Bani Amerian (1 review)", expanded=True):
...
notes_list = [{"title": "Public Speaking Guide", "file": "comm1112_notes.pdf"}]
